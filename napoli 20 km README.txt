...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=napoli+20+km&box=14.408736,40.974517,14.170772,40.794854
...
-----------
  ...
  * napoli 20 km Height Map (ASTER 30m).png
  ...
  * napoli 20 km Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * napoli 20 km Height Map (SRTM3 v4.1).png
  ...
  * napoli 20 km Height Map (SRTM30 Plus).png
